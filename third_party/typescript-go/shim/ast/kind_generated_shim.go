// Code generated from internal/ast/kind_generated.go — DO NOT EDIT.
// Pure re-export of every ast.Kind constant so packages outside the fork
// (e.g. regel.dev/regel/internal/lower) can name every node kind.
...
const (
	...
	KindDeferKeyword = ast.KindDeferKeyword
	...
	KindJSDocAllType = ast.KindJSDocAllType
	...
	KindJSDocUnknownTag = ast.KindJSDocUnknownTag
	...
	KindJSDocThrowsTag = ast.KindJSDocThrowsTag
	...
	KindLastUnaryOperator = ast.KindLastUnaryOperator
